...
export const translations: Record<string, TranslationRecord> = {
	en: {
		...
		var_builtin_hint: 'Built-in: {{date}}, {{time}}, {{random:N}}, {{date+7d}}, {{time-1h}}',
	...
	ru: {
		...
		trigger_char_label: 'Символ-префикс',
		...
		variables_enabled_label: 'Переменные как шорткаты',
		...
		var_builtin_hint: 'Встроенные: {{date}}, {{time}}, {{random:N}}, {{date+7d}}, {{time-1h}}',
	...
	es: {
		...
		var_builtin_hint: 'Integradas: {{date}}, {{time}}, {{random:N}}, {{date+7d}}, {{time-1h}}',
	...
	ja: {
		...
		trigger_char_label: 'トリガープレフィックス',
		hotkey_label: 'グローバルホットキー',
		hotkey_not_set: '未設定',
		hotkey_record: '記録',
		hotkey_recording: 'キーの組み合わせを押してください...',
		hotkey_clear: 'クリア',
		variables_enabled_label: '変数をショートカットとして',
		...
		var_builtin_hint: '組み込み: {{date}}, {{time}}, {{random:N}}, {{date+7d}}, {{time-1h}}',
