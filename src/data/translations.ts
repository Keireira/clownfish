...
export const translations: Record<string, TranslationRecord> = {
	en: {
		...
		hints_off: 'Disabled',
		stoplist_label: 'App Exclusions',
		stoplist_expansion: 'Expansion',
		stoplist_hints: 'Hints',
		stoplist_empty: 'All apps allowed',
		stoplist_add_app: 'Add Application',
	...
	ru: {
		...
		hints_off: 'Выключены',
		stoplist_label: 'Исключения приложений',
		stoplist_expansion: 'Замена',
		stoplist_hints: 'Подсказки',
		stoplist_empty: 'Все приложения разрешены',
		stoplist_add_app: 'Добавить приложение',
	...
	es: {
		...
		stoplist_label: 'Exclusiones de apps',
		stoplist_expansion: 'Expansión',
		stoplist_hints: 'Sugerencias',
		stoplist_empty: 'Todas las apps permitidas',
		stoplist_add_app: 'Añadir aplicación',
	...
	ja: {
		...
		hints_corner: '右下コーナー',
		hints_off: '無効',
		stoplist_label: 'アプリ除外',
		stoplist_expansion: '展開',
		stoplist_hints: 'ヒント',
		stoplist_empty: 'すべてのアプリ許可',
		stoplist_add_app: 'アプリを追加',
