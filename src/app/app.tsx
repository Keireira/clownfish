...
import Root, { AppGlobalStyle, GridArea, NoResults, SettingsBtn, BtnGroup } from './app.styles';
...
export default function App() {
	...
	const openShortcuts = () => {
		// Open settings window and emit event to switch to shortcuts tab
		import('@tauri-apps/api/core')
			.then(({ invoke }) => invoke('open_settings_cmd'))
			.then(() => import('../events').then(({ emitEvent }) => emitEvent('open-shortcuts-tab')))
			.catch((e) => console.error('Failed to open shortcuts:', e));
	};
		...
		<CharPreviewProvider>
			...
			<Root ref={appRef}>
				...
				<BottomBar
					right={
						<BtnGroup>
							<SettingsBtn onClick={openShortcuts}>
								<svg width="14" height="14" viewBox="0 0 20 20" fill="currentColor">
									<path d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h7a1 1 0 110 2H4a1 1 0 01-1-1zm10 0a1 1 0 011-1h2a1 1 0 110 2h-2a1 1 0 01-1-1z" />
								</svg>
								<span>{t('tab_shortcuts')}</span>
							</SettingsBtn>
